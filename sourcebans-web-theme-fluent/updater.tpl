...
<html>
    <head>
        ...
        <title>Aktualizator | SourceBans++</title>
    ...
    <body>
        <div id="header">
            <div id="head-logo">
                <a href="index.php"><img src="../images/logos/sb-large.png" border="0" alt="Logo SourceBans" /></a>
            </div>
        </div>
        <div id="tabsWrapper"></div>
        <div id="mainwrapper">
            <div id="content_title" style="padding: 1rem 0rem"><b>Aktualizator</b></div>
            <div id="content">
                <h3>Trwa aktualizacja...</h3>
        ...
        <div id="footer">
            <div id="mainwrapper" style="text-align: center;">
    		    ...
    		    <span style="line-height: 20px;">Napędzane przez <a href="http://www.sourcemod.net" target="_blank" style="color: #C1C1C1">SourceMod</a></span>
    		</div>
    	</div>
    </body>
</html>
