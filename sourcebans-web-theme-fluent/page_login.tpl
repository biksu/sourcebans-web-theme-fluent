        ...
        <div class="padding">
                    ...
                    <div class="flex flex-jc:space-between flex-ai:center">
                        <span class="input_checkbox">
                            <input id="loginRememberMe" type="checkbox" name="remember" value="checked"
                                class="form-check" />
                            <label for="loginRememberMe" class="form-label form-label:left">Zapamiętaj mnie</label>
                        </span>
                    </div>
            ...
            -{if $steamlogin_show == 1}-
                <div class="flex margin-top">
                    -{sb_button text="Zaloguj się" onclick=$redir class="button button-success flex:11" id="alogin" submit=false}-
                </div>
            -{/if}-

            <div class="margin-top text:center">
                <a href="index.php?p=login&o=steam">
                    <img src="images/steamlogin.png" alt="Zaloguj przez Steam">
                </a>
            </div>
        </div>
    </div>
