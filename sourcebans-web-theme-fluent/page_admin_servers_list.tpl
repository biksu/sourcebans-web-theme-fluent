<div class="layout_box flex:11 admin_tab_content tabcontent" id="List servers" style="display: block;">
    ...
    {else}
        <div class="admin_tab_content_title">
            <h2><i class="fas fa-server"></i> Serwery (<span id="srvcount">{$server_count}</span>)</h2>
        </div>
        ...
        <div class="padding">
                ...
                <table>
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Mod</th>
                            <th class="text:left">Nazwa hosta</th>
                            <th>Gracze</th>
                            <th>Akcja</th>
                        </tr>
                    </thead>
            ...
            {if $permission_addserver}
                <div class="margin-top">
                    <button class="button button-light" title="Kliknij, aby wgrać zrzut ekranu mapy. Jako nazwy pliku użyj nazwy mapy." id="upload"
