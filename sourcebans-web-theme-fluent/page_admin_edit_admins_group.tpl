<div class="layout_box flex:11 admin_tab_content">
    <div class="admin_tab_content_title">
        <h2><i class="fas fa-user-edit"></i> Grupy administratora</h2>
    </div>
    ...
    <div class="padding">
        ...
        <div class="margin-bottom:half">
            Wybierz nowe grupy, do których ma należeć <span class="text:bold">{$group_admin_name}</span>.
        </div>
        ...
        <form action="" method="post">
            ...
            <div class="flex flex-ai:center flex-jc:space-between margin-top">
                {sb_button text="Zapisz zmiany" class="button button-success" id="agroups" submit=true}
