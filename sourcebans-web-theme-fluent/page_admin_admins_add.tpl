<div class="layout_box flex:11 admin_tab_content tabcontent" id="Add new admin">
  ...
  <div class="admin_tab_content_title">
    <h2><i class="fas fa-user-plus"></i> Dodaj nowego administratora</h2>
  </div>

  <div class="padding">
    <div id="msg-green" class="message message:succes margin-bottom:half" style="display: none;">
      <h3>Dodano administratora</h3>
      <div>Nowy administrator został pomyślnie dodany do systemu.</div>
      <div class="text:italic">Przekierowywanie z powrotem do strony administratorów</div>
    </div>
      ...
      <form class="form">
        ...
        <div class="margin-bottom:half">
          ...
          <div class="flex margin-top:half">
            <button id="password_generate" class="button button-light button:line flex:11 margin-right:half">
              <i class="fas fa-sync"></i> Wygeneruj losowe hasło
            </button>

            <button id="password_show" class="button button-light button:line flex:11">
              <i class="fas fa-eye"></i> Pokaż hasło
            </button>
          </div>
        ...
        <div class="margin-bottom:half">
          <label for="password2" class="form-label form-label:bottom">
            Hasło administratora (potwierdź)
          </label>
        ...
        <div class="margin-bottom:half">
          ...
          <input type="password" TABINDEX=7 class="form-input form-full" name="a_serverpass" id="a_serverpass"
            disabled="disabled" />
          <div class="form-desc">
            Jeśli to pole jest zaznaczone, musisz podać to hasło na serwerze gry, zanim będziesz mógł używać uprawnień administratora.
            <a href="http://wiki.alliedmods.net/Adding_Admins_%28SourceMod%29#Passwords" rel="noopener" target="_blank"
              class="text:bold">Informacje o haśle SourceMod</a>
          </div>
        ...
        <div class="margin-bottom:half">
          <h4 class="form-label">Dostęp grup serwerowych</h4>
          ...
          <h4 class="form-label">Dostęp do serwerów</h4>
          ...
          <ul class="list-reset">
            ...
            <li class="margin-bottom:half">
              ...
              <label for="servers[{$server.sid}]" id="sa{$server.sid}" class="form-label form-label:left">
                Pobieranie nazwy hosta... {$server.ip}:{$server.port}
              </label>
            </li>
            {/foreach}
          </ul>
        ...
        <div class="margin-bottom:half">
          ...
          <select TABINDEX=8 onchange="update_server()" name="serverg" id="serverg" class="form-select form-full">
            ...
            <option value="-3">Brak uprawnień</option>
            <option value="c">Niestandardowe uprawnienia</option>
            <option value="n">Nowa grupa administratorów</option>
            <optgroup label="Grupy" style="font-weight:bold;">
        ...
        <div class="flex flex-jc:space-between flex-ai:center margin-top">
          {sb_button text="Dodaj administratora" onclick="ProcessAddAdmin();" class="button button-success" id="aadmin" submit=false}
